...
class AIProviderOption {
  ...
  static List<AIProviderOption> get allProviders => [
        ...
        const AIProviderOption(
          ...
          features: ['Gemini 2.0 Flash', 'Free tier available', 'Multimodal'],
        ),
        const AIProviderOption(
          id: 'anthropic',
          ...
          features: ['Claude 3.5 Sonnet', 'Best for writing', 'Long context'],
        ),
        const AIProviderOption(
          id: 'openrouter',
          name: 'OpenRouter',
