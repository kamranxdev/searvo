...
# This script runs the Flutter Linux app in development mode
...
build_prod() {
    print_status "Building Flutter Linux app for production..."
    
    flutter config --enable-linux-desktop >/dev/null 2>&1
    flutter pub get
    flutter build linux --release
    
    print_success "Build completed! Files are in build/linux/x64/release/bundle/"
}
