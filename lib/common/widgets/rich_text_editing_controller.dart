...
class RichTextEditingController extends TextEditingController {
  ...
  TextSpan buildTextSpan({
    ...
    final pattern = RegExp(r'@\w+|https?://[^\s]+', caseSensitive: false);
    ...
    for (final match in pattern.allMatches(text)) {
      ...
      switch (detectedType) {
        ...
        case DetectedType.url:
          specialStyle = style?.copyWith(
            color: urlColor ?? Theme.of(context).colorScheme.primary,
      ...
      spans.add(TextSpan(text: matchedText, style: specialStyle));
