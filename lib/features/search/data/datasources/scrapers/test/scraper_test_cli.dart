...
/// Usage: dart run lib/features/search/data/datasources/scrapers/test/scraper_test_cli.dart
void main(List<String> args) async {
  ...
  if (args.isEmpty) {
    ...
    print('');
    print('Examples:');
    print('  dart run lib/features/search/data/datasources/scrapers/test/scraper_test_cli.dart test-all');
    print('  dart run lib/features/search/data/datasources/scrapers/test/scraper_test_cli.dart test-url "https://youtube.com/..."');
    return;
  }
